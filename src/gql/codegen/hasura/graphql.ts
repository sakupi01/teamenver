...
export type UpdateTeamBoardDetailsMutation = { __typename?: 'mutation_root', update_team_board_details?: { __typename?: 'team_board_details_mutation_response', returning: Array<{ __typename?: 'team_board_details', id: string }> } | null };
...
export type InsertTeamMemberMutation = { __typename?: 'mutation_root', insert_team_member_one?: { __typename?: 'team_member', team_id: string, user_id: string } | null };
...
export type GetBoardLibrariesQueryVariables = Exact<{
  board_detail_id: Scalars['uuid']['input'];
}>;


export type GetBoardLibrariesQuery = { __typename?: 'query_root', board_details: Array<{ __typename?: 'board_details', id: string, framework?: string | null, css_library?: string | null, ui_library?: string | null }>, boards: Array<{ __typename?: 'boards', id: string, is_public: boolean }> };
...
export type GetTeamMemberQuery = { __typename?: 'query_root', team_member: Array<{ __typename?: 'team_member', users: { __typename?: 'users', id: string, name: string, email: string, image_url: string, github_url?: string | null, twitter_url?: string | null } }> };
...
export type GetTeamBoardDetailQuery = { __typename?: 'query_root', teams_by_pk?: { __typename?: 'teams', team_boards?: { __typename?: 'team_boards', team_board_detail?: { __typename?: 'team_board_details', id: string, framework: string, css_library: string, ui_library: string, linter: string, formatter: string } | null } | null } | null };
...
export const GetBoardLibrariesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetBoardLibraries"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"board_detail_id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"board_details"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"board_detail_id"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"framework"}},{"kind":"Field","name":{"kind":"Name","value":"css_library"}},{"kind":"Field","name":{"kind":"Name","value":"ui_library"}}]}},{"kind":"Field","name":{"kind":"Name","value":"boards"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"board_detail"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"board_detail_id"}}}]}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"is_public"}}]}}]}}]} as unknown as DocumentNode<GetBoardLibrariesQuery, GetBoardLibrariesQueryVariables>;
