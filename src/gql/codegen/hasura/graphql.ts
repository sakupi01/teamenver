...
export type Mutation_Root = {
  ...
  update_team_board_details_many?: Maybe<
    Array<Maybe<Team_Board_Details_Mutation_Response>>
  >
...
export type CreateTeamMutation = {
  ...
  insert_teams?: {
    ...
    returning: Array<{ __typename?: 'teams'; admin_id: string; name: string; id: any }>
  } | null
}
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'insert_teams' },
            arguments: [
              {
                kind: 'Argument',
